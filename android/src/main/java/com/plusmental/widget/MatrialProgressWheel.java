 ...
 * Todd Davies' Progress Wheel https://github.com/Todd-Davies/MatrialProgressWheel
 *
 ...
 */
public class MatrialProgressWheel extends View {
    private static final String TAG = MatrialProgressWheel.class.getSimpleName();
    ...
    /**
     * The constructor for the MatrialProgressWheel
     *
     * @param context
     * @param attrs
     */
    public MatrialProgressWheel(Context context, AttributeSet attrs) {
        super(context, attrs);

        parseAttributes(context.obtainStyledAttributes(attrs,
                R.styleable.MatrialProgressWheel));
    }
     ...
     * @param context
     */
    public MatrialProgressWheel(Context context) {
        super(context);
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.MatrialProgressWheel_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.MatrialProgressWheel_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.MatrialProgressWheel_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.MatrialProgressWheel_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.MatrialProgressWheel_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.MatrialProgressWheel_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.MatrialProgressWheel_barColor, barColor);

        rimColor = a.getColor(R.styleable.MatrialProgressWheel_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.MatrialProgressWheel_linearProgress, false);

        if (a.getBoolean(R.styleable.MatrialProgressWheel_progressIndeterminate, false)) {
            spin();
        }
